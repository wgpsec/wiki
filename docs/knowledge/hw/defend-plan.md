---
title: 【蓝队】2020攻防演练防守心得
---
## 【蓝队】2020攻防演练防守心得
## 知己知彼，百战不殆

安全圈有一句话叫做“未知攻，焉知防”，防守方要先学会从攻击者的角度考虑如何攻破一个系统。
...
社工是最难防范的，最近B站上了一部电影《我是谁: 没有绝对安全的系统》电影中CLAY上演了一波教科书般的社会工程学渗透，用邮件钓鱼加近源渗透的方法成功侵入了情报局系统。电影中有句台词 "很多人都尝试黑进情报局，但你躲在自己的电脑前肯定无法做到" ，说明了近源渗透的必要性，懂的人自然懂，不懂的慢慢了解~



0day包括未公开的漏洞和攻击方法，0Day漏洞本身就是个永恒的问题，安全产品自身也无法避免0Day攻击，即使我们做好了应对前边几种攻击的所有措施还是会被手握0day的大佬轻松打穿，真的是防不胜防。当然也不能坐以待毙，发现被打进来后要迅速应急响应把危害和损失控制到最小范围，真正的做到可感、可控。
...
| 业务系统名称（title） | URL/端口                                                | 系统所在区域 | 中间件/组件信息 | 公网IP          | 内网IP        |
| --------------------- | ------------------------------------------------------- | ------------ | --------------- | --------------- | ------------- |
| 百度搜索              | [https://www.baidu.com](https://www.baidu.com/)         | 外网         | BWS/1.0         | 233.233.233.233 | 10.10.10.123  |
| 莆田系医院官网        | [http://192.168.1.110:8886](http://192.168.1.110:8886/) | 内网         | Tomcat          |                 | 192.168.1.110 |

#### 基线加固

之后对重点系统进行系统**基线检查和加固**，涉及到Windows和Linux两种主流系统。
...
在内网的必经之路部署一个MySQL蜜罐，这样万一被打进了内网，攻击者对内网扫描的时候我就能及时的发现，否则被打穿了都没任何察觉岂不是太惨了。
...
**影子守护者：**https://shadowd.zecure.org/
